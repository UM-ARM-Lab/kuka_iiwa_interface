...
int main(int argc, char** argv)
{
    ...
    // Joint limits
    const std::map<std::string, iiwa_robot_controllers::JointLimits> joint_limits = iiwa_robot_controllers::GetArmLimits(real_velocity_limit_scaling);
    // Joint PID params
    const std::map<std::string, iiwa_robot_controllers::PIDParams> joint_controller_params = iiwa_robot_controllers::GetArmDefaultPositionControllerParams();
