...
int main(int argc, char** argv)
{
    ...
    const std::string DEFAULT_TORQUE_COMMAND_TOPIC = "joint_command_torque";
    ...
    // Joint PID params
    const std::map<std::string, iiwa_robot_controllers::PIDParams> joint_controller_params = iiwa_robot_controllers::GetArmDefaultVelocityControllerParams();
