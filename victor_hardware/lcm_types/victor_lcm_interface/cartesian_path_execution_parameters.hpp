...
#ifndef __victor_lcm_interface_cartesian_path_execution_parameters_hpp__
#define __victor_lcm_interface_cartesian_path_execution_parameters_hpp__
...
class cartesian_path_execution_parameters {
 public:
  victor_lcm_interface::cartesian_value_quantity max_velocity;

  victor_lcm_interface::cartesian_value_quantity max_acceleration;
...
int cartesian_path_execution_parameters::getEncodedSize() const { return 8 + _getEncodedSizeNoHash(); }
...
const char *cartesian_path_execution_parameters::getTypeName() { return "cartesian_path_execution_parameters"; }
...
uint64_t cartesian_path_execution_parameters::_computeHash(const __lcm_hash_ptr *p) {
  ...
  for (fp = p; fp != NULL; fp = fp->parent)
    if (fp->v == cartesian_path_execution_parameters::getHash) return 0;
  const __lcm_hash_ptr cp = {p, (void *)cartesian_path_execution_parameters::getHash};

  uint64_t hash = 0xa5c0017a3cb11d5dLL + victor_lcm_interface::cartesian_value_quantity::_computeHash(&cp) +
