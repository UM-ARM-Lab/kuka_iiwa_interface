...
#ifndef __victor_lcm_interface_control_mode_parameters_hpp__
#define __victor_lcm_interface_control_mode_parameters_hpp__
...
class control_mode_parameters {
 public:
  victor_lcm_interface::joint_impedance_parameters joint_impedance_params;

  victor_lcm_interface::cartesian_impedance_parameters cartesian_impedance_params;

  victor_lcm_interface::cartesian_control_mode_limits cartesian_control_mode_limits;

  victor_lcm_interface::joint_path_execution_parameters joint_path_execution_params;

  victor_lcm_interface::cartesian_path_execution_parameters cartesian_path_execution_params;

  victor_lcm_interface::control_mode control_mode;
...
int control_mode_parameters::getEncodedSize() const { return 8 + _getEncodedSizeNoHash(); }
...
const char *control_mode_parameters::getTypeName() { return "control_mode_parameters"; }
...
uint64_t control_mode_parameters::_computeHash(const __lcm_hash_ptr *p) {
  ...
  for (fp = p; fp != NULL; fp = fp->parent)
    if (fp->v == control_mode_parameters::getHash) return 0;
  const __lcm_hash_ptr cp = {p, (void *)control_mode_parameters::getHash};

  uint64_t hash = 0x6405e1de1a319e2dLL + victor_lcm_interface::joint_impedance_parameters::_computeHash(&cp) +
                  victor_lcm_interface::cartesian_impedance_parameters::_computeHash(&cp) +
                  victor_lcm_interface::cartesian_control_mode_limits::_computeHash(&cp) +
                  victor_lcm_interface::joint_path_execution_parameters::_computeHash(&cp) +
                  victor_lcm_interface::cartesian_path_execution_parameters::_computeHash(&cp) +
