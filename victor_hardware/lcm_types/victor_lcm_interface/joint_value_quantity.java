...
public final class joint_value_quantity implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(victor_lcm_interface.joint_value_quantity.class))
            return 0L;
 
        classes.add(victor_lcm_interface.joint_value_quantity.class);
    ...
    public static victor_lcm_interface.joint_value_quantity _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        victor_lcm_interface.joint_value_quantity o = new victor_lcm_interface.joint_value_quantity();
    ...
    public victor_lcm_interface.joint_value_quantity copy()
    {
        victor_lcm_interface.joint_value_quantity outobj = new victor_lcm_interface.joint_value_quantity();
