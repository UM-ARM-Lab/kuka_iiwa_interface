...
public final class robotiq_3finger_actuator_command implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(victor_lcm_interface.robotiq_3finger_actuator_command.class))
            return 0L;
 
        classes.add(victor_lcm_interface.robotiq_3finger_actuator_command.class);
    ...
    public static victor_lcm_interface.robotiq_3finger_actuator_command _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        victor_lcm_interface.robotiq_3finger_actuator_command o = new victor_lcm_interface.robotiq_3finger_actuator_command();
    ...
    public victor_lcm_interface.robotiq_3finger_actuator_command copy()
    {
        victor_lcm_interface.robotiq_3finger_actuator_command outobj = new victor_lcm_interface.robotiq_3finger_actuator_command();
