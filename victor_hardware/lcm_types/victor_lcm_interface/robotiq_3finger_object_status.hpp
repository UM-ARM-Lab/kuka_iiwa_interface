...
int robotiq_3finger_object_status::getEncodedSize() const { return 8 + _getEncodedSizeNoHash(); }
...
const char *robotiq_3finger_object_status::getTypeName() { return "robotiq_3finger_object_status"; }
