...
public final class control_mode_command implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(armlab.lcm.msgs.control_mode_command.class))
            return 0L;
 
        classes.add(armlab.lcm.msgs.control_mode_command.class);
    ...
    public static armlab.lcm.msgs.control_mode_command _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        armlab.lcm.msgs.control_mode_command o = new armlab.lcm.msgs.control_mode_command();
    ...
    public armlab.lcm.msgs.control_mode_command copy()
    {
        armlab.lcm.msgs.control_mode_command outobj = new armlab.lcm.msgs.control_mode_command();
