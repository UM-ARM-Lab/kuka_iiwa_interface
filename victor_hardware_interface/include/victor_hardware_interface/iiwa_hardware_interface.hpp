...
namespace iiwa_hardware_interface
{
    ...
    protected:
        ...
        victor_hardware_interface::CartesianControlModeLimits ConvertCartesianControlModeLimits(const victor_hardware_interface::cartesian_control_mode_limits& cartesian_control_mode_limits) const;

        victor_hardware_interface::cartesian_control_mode_limits ConvertCartesianControlModeLimits(const victor_hardware_interface::CartesianControlModeLimits& cartesian_control_mode_limits) const;
