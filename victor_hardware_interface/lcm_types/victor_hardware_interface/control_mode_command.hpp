...
#ifndef __victor_hardware_interface_control_mode_command_hpp__
#define __victor_hardware_interface_control_mode_command_hpp__
...
uint64_t control_mode_command::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x9697ed1b5b3d7921LL +
