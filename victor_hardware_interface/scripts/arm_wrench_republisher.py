...
hand_wrench_pub = {'left':  rospy.Publisher('left_gripper/wrench', WrenchStamped, queue_size=10),
                   'right': rospy.Publisher('right_gripper/wrench', WrenchStamped, queue_size=10)}
