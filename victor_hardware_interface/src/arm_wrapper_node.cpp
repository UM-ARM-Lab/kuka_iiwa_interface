...
int main(int argc, char** argv)
{
    ...
    {
        auto lcm_ptr = std::make_shared<lcm::LCM>(send_lcm_url);
    ...
    {
        auto send_lcm_ptr = std::make_shared<lcm::LCM>(send_lcm_url);
        auto recv_lcm_ptr = std::make_shared<lcm::LCM>(recv_lcm_url);
