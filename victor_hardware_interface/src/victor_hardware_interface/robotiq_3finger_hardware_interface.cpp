...
{
    Robotiq3FingerHardwareInterface::Robotiq3FingerHardwareInterface(const std::shared_ptr<lcm::LCM>& send_lcm_ptr, const std::shared_ptr<lcm::LCM>& recv_lcm_ptr, const std::string& command_channel_name, const std::string& status_channel_name, const std::function<void(const victor_hardware_interface::Robotiq3FingerStatus&)>& status_callback_fn) : send_lcm_ptr_(send_lcm_ptr), recv_lcm_ptr_(recv_lcm_ptr), command_channel_name_(command_channel_name), status_channel_name_(status_channel_name), status_callback_fn_(status_callback_fn)
    {
    ...
    victor_hardware_interface::robotiq_3finger_actuator_command Robotiq3FingerHardwareInterface::ConvertFingerCommand(const victor_hardware_interface::Robotiq3FingerActuatorCommand& finger_command) const
    {
        victor_hardware_interface::robotiq_3finger_actuator_command lcm_command;
    ...
    victor_hardware_interface::Robotiq3FingerActuatorStatus Robotiq3FingerHardwareInterface::ConvertFingerStatus(const victor_hardware_interface::robotiq_3finger_actuator_status& finger_status) const
    {
        victor_hardware_interface::Robotiq3FingerActuatorStatus ros_status;
    ...
    victor_hardware_interface::Robotiq3FingerObjectStatus Robotiq3FingerHardwareInterface::ConvertObjectStatus(const victor_hardware_interface::robotiq_3finger_object_status& object_status) const
    {
        victor_hardware_interface::Robotiq3FingerObjectStatus ros_status;
        ros_status.status = (uint8_t)object_status.status;
        ros_status.header.stamp = ros::Time(object_status.timestamp);
        return ros_status;
    }

    victor_hardware_interface::Robotiq3FingerStatus Robotiq3FingerHardwareInterface::ConvertStatus(const victor_hardware_interface::robotiq_3finger_status& status) const
    {
        victor_hardware_interface::Robotiq3FingerStatus ros_status;
    ...
    victor_hardware_interface::robotiq_3finger_command Robotiq3FingerHardwareInterface::ConvertCommand(const victor_hardware_interface::Robotiq3FingerCommand& command) const
    {
        victor_hardware_interface::robotiq_3finger_command lcm_command;
    ...
    bool Robotiq3FingerHardwareInterface::SendCommandMessage(const victor_hardware_interface::Robotiq3FingerCommand& command)
    {
        const victor_hardware_interface::robotiq_3finger_command lcm_command = ConvertCommand(command);
    ...
    void Robotiq3FingerHardwareInterface::InternalStatusLCMCallback(const lcm::ReceiveBuffer* buffer, const std::string& channel, const victor_hardware_interface::robotiq_3finger_status* status_msg)
    {
        UNUSED(buffer);
        UNUSED(channel);
        const victor_hardware_interface::Robotiq3FingerStatus ros_status = ConvertStatus(*status_msg);
