...
def get_cartesian_impedance_params(velocity=2.5):
    ...
    new_control_mode.cartesian_path_execution_params.max_velocity.a = velocity * rotation_scale
    new_control_mode.cartesian_path_execution_params.max_velocity.b = velocity * rotation_scale
    new_control_mode.cartesian_path_execution_params.max_velocity.c = velocity * rotation_scale
    ...
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.a = velocity * 2.0 * rotation_scale
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.b = velocity * 2.0 * rotation_scale
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.c = velocity * 2.0 * rotation_scale
