...
def get_control_mode_params(control_mode: ControlMode, stiffness=Stiffness.MEDIUM, vel=0.1, accel=0.1, z_force_limit=20.0):
    if control_mode == ControlMode.JOINT_POSITION:
        ...
        return get_cartesian_impedance_params(velocity=vel * 100, z_force_limit=z_force_limit)
    elif control_mode == ControlMode.CARTESIAN_POSE:
        return get_cartesian_pose_params(velocity=vel * 100)
        # raise NotImplementedError("Cartesian Mode not yet implemented")
    elif control_mode ==ControlMode.MEDSETUP:
        return get_med_setup_params()
    else:
...
def  get_med_setup_params():
    velocity = 0.1
    new_control_mode = ControlModeParameters()
    new_control_mode.control_mode.mode = ControlMode.MEDSETUP
    ...
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.a = velocity * 0.25
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.b = velocity * 0.25
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.c = velocity * 0.25
...
def get_cartesian_pose_params(velocity=2.5):
    """
    Returns predefined cartesian impedance parameters
    """
    # TODO allow sub-modes such as xy planar motion
    new_control_mode = ControlModeParameters()
    new_control_mode.control_mode.mode = ControlMode.CARTESIAN_POSE
    new_control_mode.cartesian_path_execution_params.max_velocity.x = velocity
    new_control_mode.cartesian_path_execution_params.max_velocity.y = velocity
    new_control_mode.cartesian_path_execution_params.max_velocity.z = velocity
    new_control_mode.cartesian_path_execution_params.max_velocity.a = velocity * 0.25
...
def get_cartesian_impedance_params(velocity=2.5, z_force_limit=20.0):
    """
    Returns predefined cartesian impedance parameters
    """
    # TODO allow sub-modes such as xy planar motion
    ...
    new_control_mode.cartesian_path_execution_params.max_velocity.y = velocity
    new_control_mode.cartesian_path_execution_params.max_velocity.z = velocity
    new_control_mode.cartesian_path_execution_params.max_velocity.a = velocity * 0.05
    new_control_mode.cartesian_path_execution_params.max_velocity.b = velocity * 0.05
    new_control_mode.cartesian_path_execution_params.max_velocity.c = velocity * 0.05
    new_control_mode.cartesian_path_execution_params.max_nullspace_velocity = 750.0
    new_control_mode.cartesian_path_execution_params.max_acceleration.x = 10.0
    new_control_mode.cartesian_path_execution_params.max_acceleration.y = 10.0
    new_control_mode.cartesian_path_execution_params.max_acceleration.z = 10.0
    new_control_mode.cartesian_path_execution_params.max_acceleration.a = 10.0
    new_control_mode.cartesian_path_execution_params.max_acceleration.b = 10.0
    new_control_mode.cartesian_path_execution_params.max_acceleration.c = 10.0
    new_control_mode.cartesian_path_execution_params.max_nullspace_acceleration = 1.0
    new_control_mode.cartesian_impedance_params.cartesian_damping.x = 0.5
    new_control_mode.cartesian_impedance_params.cartesian_damping.y = 0.5
    new_control_mode.cartesian_impedance_params.cartesian_damping.z = 0.5
    new_control_mode.cartesian_impedance_params.cartesian_damping.a = 0.5
    new_control_mode.cartesian_impedance_params.cartesian_damping.b = 0.5
    new_control_mode.cartesian_impedance_params.cartesian_damping.c = 0.5
    new_control_mode.cartesian_impedance_params.nullspace_damping = 0.6
    ...
    new_control_mode.cartesian_control_mode_limits.max_path_deviation.b = 10000000.0
    new_control_mode.cartesian_control_mode_limits.max_path_deviation.c = 10000000.0
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.x = velocity*1.5
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.y = velocity*1.5
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.z = velocity*1.5
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.a = velocity * 4.0 * 0.05
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.b = velocity * 4.0 * 0.05
    new_control_mode.cartesian_control_mode_limits.max_cartesian_velocity.c = velocity * 4.0 * 0.05
    new_control_mode.cartesian_control_mode_limits.max_control_force.x = 20.0
    new_control_mode.cartesian_control_mode_limits.max_control_force.y = 20.0
    new_control_mode.cartesian_control_mode_limits.max_control_force.z = z_force_limit
    # new_control_mode.cartesian_control_mode_limits.max_control_force.z = 20.0
    new_control_mode.cartesian_control_mode_limits.max_control_force.a = 20.0
    new_control_mode.cartesian_control_mode_limits.max_control_force.b = 20.0
    new_control_mode.cartesian_control_mode_limits.max_control_force.c = 20.0
