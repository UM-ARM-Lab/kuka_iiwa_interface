...
from victor_python.victor import Side
...
class VictorLeft:
    ...
    def set_left_controller(self, control_mode: str):
        ...
        # print(f"{control_mode in active_controllers[0]}")
        if len(active_controllers) > 0:
            if control_mode in active_controllers[0] :
                print(f"Controller {control_mode} is already active")
                return True
    ...
    def get_and_update_active_controller_names(self):
        ...
        controller_names = {"left": left_controller_name}
    ...
    def get_joint_cmd_dict(self):
        ...
        joint_positions = dict(zip(left_names , left_commanded_positions ))
        return joint_positions
