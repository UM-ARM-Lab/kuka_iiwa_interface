...
public final class cartesian_control_mode_limits implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(wiktor_hardware_interface.cartesian_control_mode_limits.class))
            return 0L;
 
        classes.add(wiktor_hardware_interface.cartesian_control_mode_limits.class);
    ...
    public static wiktor_hardware_interface.cartesian_control_mode_limits _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        wiktor_hardware_interface.cartesian_control_mode_limits o = new wiktor_hardware_interface.cartesian_control_mode_limits();
    ...
    {
        this.max_path_deviation = wiktor_hardware_interface.cartesian_value_quantity._decodeRecursiveFactory(ins);
 
        this.max_cartesian_velocity = wiktor_hardware_interface.cartesian_value_quantity._decodeRecursiveFactory(ins);
    ...
    public wiktor_hardware_interface.cartesian_control_mode_limits copy()
    {
        wiktor_hardware_interface.cartesian_control_mode_limits outobj = new wiktor_hardware_interface.cartesian_control_mode_limits();
