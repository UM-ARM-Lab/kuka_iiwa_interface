...
{
    public wiktor_hardware_interface.cartesian_value_quantity max_velocity;
    public wiktor_hardware_interface.cartesian_value_quantity max_acceleration;
    ...
    {
        if (classes.contains(wiktor_hardware_interface.cartesian_path_execution_parameters.class))
            return 0L;
 
        classes.add(wiktor_hardware_interface.cartesian_path_execution_parameters.class);
    ...
    public static wiktor_hardware_interface.cartesian_path_execution_parameters _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        wiktor_hardware_interface.cartesian_path_execution_parameters o = new wiktor_hardware_interface.cartesian_path_execution_parameters();
    ...
    {
        this.max_velocity = wiktor_hardware_interface.cartesian_value_quantity._decodeRecursiveFactory(ins);
 
        this.max_acceleration = wiktor_hardware_interface.cartesian_value_quantity._decodeRecursiveFactory(ins);
    ...
    public wiktor_hardware_interface.cartesian_path_execution_parameters copy()
    {
        wiktor_hardware_interface.cartesian_path_execution_parameters outobj = new wiktor_hardware_interface.cartesian_path_execution_parameters();
