...
public final class control_mode_status implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(wiktor_hardware_interface.control_mode_status.class))
            return 0L;
 
        classes.add(wiktor_hardware_interface.control_mode_status.class);
    ...
    public control_mode_status(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public control_mode_status(DataInput ins) throws IOException
    {
    ...
    public static wiktor_hardware_interface.control_mode_status _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        wiktor_hardware_interface.control_mode_status o = new wiktor_hardware_interface.control_mode_status();
    ...
    public wiktor_hardware_interface.control_mode_status copy()
    {
        wiktor_hardware_interface.control_mode_status outobj = new wiktor_hardware_interface.control_mode_status();
