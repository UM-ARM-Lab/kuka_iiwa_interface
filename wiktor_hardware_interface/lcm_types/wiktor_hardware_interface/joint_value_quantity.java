...
public final class joint_value_quantity implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(wiktor_hardware_interface.joint_value_quantity.class))
            return 0L;
 
        classes.add(wiktor_hardware_interface.joint_value_quantity.class);
    ...
    public static wiktor_hardware_interface.joint_value_quantity _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        wiktor_hardware_interface.joint_value_quantity o = new wiktor_hardware_interface.joint_value_quantity();
    ...
    public wiktor_hardware_interface.joint_value_quantity copy()
    {
        wiktor_hardware_interface.joint_value_quantity outobj = new wiktor_hardware_interface.joint_value_quantity();
