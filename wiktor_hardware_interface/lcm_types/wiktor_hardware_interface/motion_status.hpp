...
#ifndef __wiktor_hardware_interface_motion_status_hpp__
#define __wiktor_hardware_interface_motion_status_hpp__
...
{
    public:
        wiktor_hardware_interface::joint_value_quantity measured_joint_position;

        wiktor_hardware_interface::joint_value_quantity commanded_joint_position;

        wiktor_hardware_interface::joint_value_quantity measured_joint_velocity;

        wiktor_hardware_interface::joint_value_quantity measured_joint_torque;

        wiktor_hardware_interface::joint_value_quantity estimated_external_torque;

        wiktor_hardware_interface::cartesian_value_quantity measured_cartesian_pose;

        wiktor_hardware_interface::cartesian_value_quantity commanded_cartesian_pose;
...
uint64_t motion_status::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x76f416e8bc4561d8LL +
