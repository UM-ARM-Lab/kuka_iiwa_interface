...
#ifndef __wiktor_hardware_interface_robotiq_3finger_actuator_command_hpp__
#define __wiktor_hardware_interface_robotiq_3finger_actuator_command_hpp__
...
{
    uint64_t hash = 0x28eeb127b3b0bcfeLL;
