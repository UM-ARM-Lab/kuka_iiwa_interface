...
#ifndef __wiktor_hardware_interface_robotiq_3finger_status_hpp__
#define __wiktor_hardware_interface_robotiq_3finger_status_hpp__

#include "wiktor_hardware_interface/robotiq_3finger_actuator_status.hpp"
#include "wiktor_hardware_interface/robotiq_3finger_actuator_status.hpp"
#include "wiktor_hardware_interface/robotiq_3finger_actuator_status.hpp"
#include "wiktor_hardware_interface/robotiq_3finger_actuator_status.hpp"
#include "wiktor_hardware_interface/robotiq_3finger_object_status.hpp"
#include "wiktor_hardware_interface/robotiq_3finger_object_status.hpp"
#include "wiktor_hardware_interface/robotiq_3finger_object_status.hpp"
#include "wiktor_hardware_interface/robotiq_3finger_object_status.hpp"
...
class robotiq_3finger_status
{
    public:
        ...
        wiktor_hardware_interface::robotiq_3finger_actuator_status finger_a_status;

        wiktor_hardware_interface::robotiq_3finger_actuator_status finger_b_status;

        wiktor_hardware_interface::robotiq_3finger_actuator_status finger_c_status;

        wiktor_hardware_interface::robotiq_3finger_actuator_status scissor_status;

        wiktor_hardware_interface::robotiq_3finger_object_status finger_a_object_status;

        wiktor_hardware_interface::robotiq_3finger_object_status finger_b_object_status;

        wiktor_hardware_interface::robotiq_3finger_object_status finger_c_object_status;

        wiktor_hardware_interface::robotiq_3finger_object_status scissor_object_status;
...
uint64_t robotiq_3finger_status::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xc0d930b164f18db1LL +
         wiktor_hardware_interface::robotiq_3finger_actuator_status::_computeHash(&cp) +
         wiktor_hardware_interface::robotiq_3finger_actuator_status::_computeHash(&cp) +
         wiktor_hardware_interface::robotiq_3finger_actuator_status::_computeHash(&cp) +
         wiktor_hardware_interface::robotiq_3finger_actuator_status::_computeHash(&cp) +
         wiktor_hardware_interface::robotiq_3finger_object_status::_computeHash(&cp) +
         wiktor_hardware_interface::robotiq_3finger_object_status::_computeHash(&cp) +
         wiktor_hardware_interface::robotiq_3finger_object_status::_computeHash(&cp) +
         wiktor_hardware_interface::robotiq_3finger_object_status::_computeHash(&cp);
