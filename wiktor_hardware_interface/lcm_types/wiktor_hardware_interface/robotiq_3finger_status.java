...
{
    public long utime;
    public wiktor_hardware_interface.robotiq_3finger_actuator_status finger_a_status;
    public wiktor_hardware_interface.robotiq_3finger_actuator_status finger_b_status;
    public wiktor_hardware_interface.robotiq_3finger_actuator_status finger_c_status;
    public wiktor_hardware_interface.robotiq_3finger_actuator_status scissor_status;
    public wiktor_hardware_interface.robotiq_3finger_object_status finger_a_object_status;
    public wiktor_hardware_interface.robotiq_3finger_object_status finger_b_object_status;
    public wiktor_hardware_interface.robotiq_3finger_object_status finger_c_object_status;
    public wiktor_hardware_interface.robotiq_3finger_object_status scissor_object_status;
    ...
    public static final long LCM_FINGERPRINT_BASE = 0xc0d930b164f18db1L;
    ...
    {
        if (classes.contains(wiktor_hardware_interface.robotiq_3finger_status.class))
            return 0L;
 
        classes.add(wiktor_hardware_interface.robotiq_3finger_status.class);
        long hash = LCM_FINGERPRINT_BASE
             + wiktor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + wiktor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + wiktor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + wiktor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + wiktor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
             + wiktor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
             + wiktor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
             + wiktor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
            ;
    ...
    public static wiktor_hardware_interface.robotiq_3finger_status _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        wiktor_hardware_interface.robotiq_3finger_status o = new wiktor_hardware_interface.robotiq_3finger_status();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.finger_a_status = wiktor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.finger_b_status = wiktor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.finger_c_status = wiktor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.scissor_status = wiktor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.finger_a_object_status = wiktor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
 
        this.finger_b_object_status = wiktor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
 
        this.finger_c_object_status = wiktor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
 
        this.scissor_object_status = wiktor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
    ...
    public wiktor_hardware_interface.robotiq_3finger_status copy()
    {
        wiktor_hardware_interface.robotiq_3finger_status outobj = new wiktor_hardware_interface.robotiq_3finger_status();
