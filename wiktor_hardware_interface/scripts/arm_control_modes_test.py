...
import rospy
import wiktor_hardware_interface.msg
import wiktor_hardware_interface.srv
...
class ControlModeTester(object):
    ...
    def __init__(self):
        ...
        self.set_control_mode_server = rospy.ServiceProxy("set_control_mode_service",
                                                          wiktor_hardware_interface.srv.SetControlMode)
        self.set_control_mode_server.wait_for_service()
        self.get_control_mode_server = rospy.ServiceProxy("get_control_mode_service",
                                                          wiktor_hardware_interface.srv.GetControlMode)
        self.get_control_mode_server.wait_for_service()
        self.motion_command_pub = rospy.Publisher("motion_command",
                                                  wiktor_hardware_interface.msg.MotionCommand,
                                                  queue_size=1)
    ...
    def joint_position_test(self):
        ...
        control_mode_command = wiktor_hardware_interface.msg.ControlModeCommand()
        control_mode_command.control_mode = wiktor_hardware_interface.msg.ControlModeCommand.JOINT_POSITION
        ...
        request = wiktor_hardware_interface.srv.SetControlModeRequest()
    ...
    def joint_impedance_test(self):
        ...
        control_mode_command = wiktor_hardware_interface.msg.ControlModeCommand()
        control_mode_command.control_mode = wiktor_hardware_interface.msg.ControlModeCommand.JOINT_IMPEDANCE
        control_mode_command.joint_path_execution_params.joint_relative_velocity = 0.5
        control_mode_command.joint_path_execution_params.joint_relative_acceleration = 0.5
        control_mode_command.joint_path_execution_params.override_joint_acceleration = 0.0
    ...
    def cartesian_pose_test(self):
        ...
        control_mode_command = wiktor_hardware_interface.msg.ControlModeCommand()
        control_mode_command.control_mode = wiktor_hardware_interface.msg.ControlModeCommand.CARTESIAN_POSE
    ...
    def cartesian_impedance_test(self):
        ...
        control_mode_command = wiktor_hardware_interface.msg.ControlModeCommand()
        control_mode_command.control_mode = wiktor_hardware_interface.msg.ControlModeCommand.CARTESIAN_IMPEDANCE
